...
const filters: Array<{ key: NewsCategory; label: string; description: string }> = [
  {
    key: "all",
    label: "Top headlines",
...
export default async function Page({ searchParams }: DiscoverPageProps) {
  ...
  const activeFilter = filters.find((filter) => filter.key === category) ?? filters[0]
            ...
            <div className="mt-8 grid gap-8 xl:grid-cols-[minmax(0,1fr)_320px]">
              ...
              <aside className="space-y-5">
                <section className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-md">
                  <div className="text-base font-semibold text-white">Topic pivots</div>
                ...
                <section className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-md">
                  <div className="text-base font-semibold text-white">Source mix</div>
